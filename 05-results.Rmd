...
financeTable %>%
  ...
  ggplot(aes(x=Year,y=fct_inorder(Employees)))+
...
finance_short %>%
  ggplot(aes(fct_inorder(RmU),fct_inorder(NimU)))+
  geom_point() +
  theme(axis.text.x=element_text(angle=60,hjust = 1)) +
  xlab("Revenue in Million") +
  ylab("Net Income in Million") +
  ggtitle("Net Income vs Revenue from 2000-2020")
